...
Eliminating "bad hires" by providing recruiters with visual **Proof of Skill** through 15-60 second craftsmanship videos and verified project portfolios.

## Target Users

| User Type | Description |
|-----------|-------------|
| **Tradespeople** | Skilled workers building video portfolios to showcase craftsmanship |
| **Recruiters** | Hiring managers seeking verified talent with visual proof of skill |
| **Clients** | Homeowners and businesses looking for trustworthy contractors |
...
Prototype a workflow from native video upload and YouTube import through searchable, trade-specific profiles with offline-first capabilities.
